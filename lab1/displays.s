...
; -------------------------------------------------------------------------------
; Função responsável por atualizar os 2 displays
refresh_displays
        PUSH    {LR, R2}
...
show_display                                 ; R0: segmentos | R1: display ativo
        ...
        AND     R2, R0, #2_00001111          ; Máscara para separar segmentos
        AND     R3, R0, #2_11110000          ; Máscara para separar outros segmentos

        MOV     R0, R2						 ; Define as saídas na porta Q
        BL      portQ_output

        MOV     R0, R3 						 ; Define as saídas na porta A
        BL      portA_output
...
; -------------------------------------------------------------------------------
; Função responsável por mapear os digitos
